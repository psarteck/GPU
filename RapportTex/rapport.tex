...
\subsection{Méthode de Monte Carlo pour l'intégration numérique}
...
\begin{enumerate}
    \item Choisissez le nombre d'échantillons $N$.
    \item Générez $N$ échantillons aléatoires $x_i$ dans l'intervalle $[a, b]$.
    \item Calculez l'estimation de l'intégrale en utilisant la formule (1).
\end{enumerate}
...
\begin{figure}[ht!]
    ...
    \subcaptionbox{Erreur \label{subfig1}}{\includegraphics[width=0.5\linewidth]{../Images/error_montecarlo_Op_MP.png}}%
    \hfill % Ajoute une espace horizontale entre les sous-figures
    \subcaptionbox{Temps \label{subfig2}}{\includegraphics[width=0.5\linewidth]{../Images/time_montecarlo_Op_MP.png}}
  
    \caption{Méthode d'intégration de Monte-Carlo : Open MP}
    \label{fig:figure}
  \end{figure}
...
\begin{figure}[ht!]
    ...
    \subcaptionbox{Erreur \label{subfig1}}{\includegraphics[width=0.5\linewidth]{../Images/error_montecarlo_MPI.png}}%
    \hfill % Ajoute une espace horizontale entre les sous-figures
    \subcaptionbox{Temps \label{subfig2}}{\includegraphics[width=0.5\linewidth]{../Images/time_montecarlo_MPI.png}}
  
    \caption{Méthode d'intégration de Monte-Carlo : MPI}
    \label{fig:figure}
  \end{figure}
